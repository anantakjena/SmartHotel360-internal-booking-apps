...
docker build --no-cache .\SmartHotel.Registration -t mikkelhegn/smarthotelweb:mesh-1709
...
docker build --no-cache .\SmartHotel.Registration.Wcf -t mikkelhegn/smarthotelwcf:mesh-1709